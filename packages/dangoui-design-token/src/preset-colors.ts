import { definePreset, entriesToCss } from '@unocss/core'
import type { Arrayable, CSSObject } from '@unocss/core'

// Theme types (same as uno-preset-echo-colors)
...
type PresetEchoColorsOptions = {
  theme?: Record<string, Record<string, string | number>>
}

export const presetEchoColors = definePreset(
  (options: PresetEchoColorsOptions = {}) => {
    ...
    return {
      name: 'unocss-preset-echo-colors',
      rules: [
        [
          themeRegex,
          ([, brand], { theme }) => {
